...
// 구성하는 헬퍼를 제공합니다 (이슈 #276 / PR #277 리뷰).
//
...
// Build 는 LLM provider + repository + resolver 로 llmgen.Generator 를 구성합니다 (이슈 #149).
//
...
// llmgen.New 자체 실패는 wiring 버그 — 호출자 (main) 에서 Fatal 결정 (PR #277 리뷰).
