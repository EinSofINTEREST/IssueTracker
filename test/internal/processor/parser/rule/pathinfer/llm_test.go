...
// 실 운영의 pkg/llm/prompt/assets/parser/pathinfer/{system,user}.txt 와 동일한 placeholder 사용.
var testLoader = prompt.MapLoader{
	"parser/pathinfer/system": "You are an expert at RE2 regex.\nRespond with ONLY a single regex pattern.",
	"parser/pathinfer/user":   "Articles (positive):\n{{ARTICLES}}\n\nNon-articles (negative):\n{{NON_ARTICLES}}",
}
